...
BEGIN
    ...
    Begin Try
        ...
        if (@ubicacion = '' and @universidad = '') 
			insert into FAN_USUARIO(pais, celular, fechaNacimiento, descripcion, email, rolID, guID)
			values(@pais, @celular, @fechaNacimiento, @descripcion, @email, @rolID, @guID)
			
		else if (@ubicacion = '' and @universidad != '') 
			insert into FAN_USUARIO(pais, celular, fechaNacimiento, descripcion, email, rolID, universidad, guID)
			values(@pais, @celular, @fechaNacimiento, @descripcion, @email, @rolID, @universidad, @guID)
			
		else 
			insert into FAN_USUARIO(pais, celular, fechaNacimiento, descripcion, email, rolID, universidad, ubicacion, guID)
			values(@pais, @celular, @fechaNacimiento, @descripcion, @email, @rolID, @universidad, @ubicacion, @guID)
